...
<form action="{{ route('pdam.update', $pdam->id) }}" method="POST">
    ...
    <div class="row">
        ...
        <div class="col mb-3">
            ...
            <input type="text" name="nama_pelanggan" class="form-control" placeholder="Lokasi" value="{{ $pdam->nama_pelanggan }}" >
        </div>
    </div>
    <div class="row">
        <div class="col mb-3">
    ...
    <div class="row">
        ...
        <div class="col mb-3">
                ...
                <select class="form-control" name="tersedia_layanan">
                    ...
                    <option value="Tersedia Layanan" {{ $pdam->tersedia_layanan == 'Tersedia Layanan' ? 'selected' : '' }}>Tersedia Layanan</option>
                    <option value="Tidak Tersedia" {{ $pdam->tersedia_layanan == 'Tidak Tersedia' ? 'selected' : '' }}>Tidak Tersedia</option>
                </select>
            </div>
    </div>
    ...
    <div class="row">
        <div class="col mb-3">
                ...
                <select class="form-control" name="status_berlangganan">
                    ...
                    <option value="Tidak Aktif" {{ $pdam->status_berlangganan == 'Tidak Aktif' ? 'selected' : '' }}>Tidak Aktif</option>
                </select>
            </div>
        <div class="col mb-3">
